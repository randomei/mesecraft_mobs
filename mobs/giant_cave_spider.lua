...
mobs:register_mob("mesecraft_mobs:giant_cave_spider", {
	...
	do_custom = function(self, dtime)
		...
		pos.y = pos.y + self.object:get_properties().collisionbox[2] - 0.2

		local dir_x = -math.sin(yaw) * (self.object:get_properties().collisionbox[4] + 0.5)
		local dir_z = math.cos(yaw) * (self.object:get_properties().collisionbox[4] + 0.5)
